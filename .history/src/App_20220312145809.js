function App() {
  return (
    <>
      <header className="header flex items-center justify-center gap-x-5 text-white mb-5">
      ...
      <section className="movies-layout">
        <h2 className="capitalize text-white mb-5 text-2xl font-bold page-container-fluid">
          Now playing
        </h2>
      </section>
    </>
